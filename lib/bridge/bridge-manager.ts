...
import { createQQAdapter } from './qq-adapter';
import { createWechatAdapter } from './wechat-adapter';
import { downloadMedia, bufferToBase64, detectMime, splitMediaFromOutput, formatSize, setMediaLocalRoots, isExtractableReplyMediaSource } from './media-utils';
import { mediaItemKey, normalizeMediaItems } from './media-item-normalizer';
import { MediaDeliveryService } from './media-delivery-service';
import { MediaPublisher } from './media-publisher';
import { collectBridgeMediaAllowedRoots } from './media-roots';
import { AppError } from '../../shared/errors';
import { errorBus } from '../../shared/error-bus';
import { handleRcPendingInput } from '../../core/slash-commands/rc-pending-handler';
import { collectMediaItems } from '../tools/media-details';
import { formatSettingsUpdateText } from '../tools/settings-update-result';
import { isBridgeOwner, resolveBridgeOwnerDeliveryTarget } from './owner-policy';
import { normalizeBridgePlatforms } from './bridge-context';
import { createModuleLogger } from '../debug-log';
import { t } from '../i18n';
import { stripToolProtocolTagsFromProse } from '../tool-protocol-sanitizer';
