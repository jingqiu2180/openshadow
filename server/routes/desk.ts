...
import { installSkillPackageFromPath } from '../../lib/skills/skill-package-installer';
import { WORKSPACE_SKILL_DIRS } from '../../shared/workspace-skill-paths';
import { DEFAULT_DISABLED_TOOL_NAMES } from '../../shared/tool-categories';
import { applyMarkdownCoverFromGeneratedFile } from '../../plugins/beautify/lib/markdown-cover-service';
import { resolveCoverGalleryPresetImagePath } from '../../plugins/beautify/lib/cover-gallery-assets';
import { buildCoverStyleGuideForAgent } from '../../plugins/beautify/lib/cover-style-guide';
import { createSubmitContext, validateImageModelRef } from '../../plugins/image-gen/lib/image-task-runner';
import { DEFAULT_ACTIVITY_EXECUTION_TIMEOUT_MS, activityTimeoutPatch } from '../../lib/desk/activity-store';
import { emitAppEvent } from '../app-events';
import { t } from '../../lib/i18n';
import { realPath, isSensitivePath } from '../utils/path-security';
import { readAuthPrincipal } from '../http/capability-guard';
import { jsonRouteError } from '../http/route-errors';
