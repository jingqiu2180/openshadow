...
import { injectGlobalFields } from '../../shared/config-scope';
import { computeSettingsAvailableToolNames } from '../../shared/tool-categories';
import { readPinnedMemoryItems } from '../../lib/memory/pinned-memory-store';
import { listExperienceDocuments } from '../../lib/tools/experience';
import { createAccessSummary, getLanAddresses } from './access';
import { buildBridgeStatus } from './bridge';
import { buildComputerUsePreferences } from './preferences';
...
import { normalizeSearchApiKeys, SEARCH_API_PROVIDER_IDS } from '../../shared/search-providers';
import { maskObjectSecrets, maskSecretValue } from '../../shared/secret-custody';
import { listResolvedExperiments } from '../../lib/experiments/registry';
import { normalizeBridgePermissionMode } from '../../core/session-permission-mode';
import { agentExists, validateId } from '../utils/validation';
