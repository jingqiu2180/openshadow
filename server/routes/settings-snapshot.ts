...
import { injectGlobalFields } from '../../shared/config-scope.js';
import { computeSettingsAvailableToolNames } from '../../shared/tool-categories.js';
import { readPinnedMemoryItems } from '../../lib/memory/pinned-memory-store.js';
import { listExperienceDocuments } from '../../lib/tools/experience.js';
import { createAccessSummary, getLanAddresses } from './access.js';
import { buildBridgeStatus } from './bridge.js';
import { buildComputerUsePreferences } from './preferences.js';
...
import { normalizeSearchApiKeys, SEARCH_API_PROVIDER_IDS } from '../../shared/search-providers.js';
import { maskObjectSecrets, maskSecretValue } from '../../shared/secret-custody.js';
import { listResolvedExperiments } from '../../lib/experiments/registry.js';
import { normalizeBridgePermissionMode } from '../../core/session-permission-mode.js';
import { agentExists, validateId } from '../utils/validation.js';
import { readAuthPrincipal } from '../http/capability-guard.js';
import { isLocalOwnerPrincipal } from '../http/route-security.js';
import { readUserProfile } from '../../lib/user-profile-store.js';
