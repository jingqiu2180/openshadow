 ...
 *
 * 优先级：OPEN_SHADOW_ROOT 环境变量 > 自动推算
 */
...
export const OPEN_SHADOW_ROOT = process.env.OPEN_SHADOW_ROOT || path.resolve(__dirname, "..");
...
export function fromRoot(...segments) {
  return path.join(OPEN_SHADOW_ROOT, ...segments);
}
